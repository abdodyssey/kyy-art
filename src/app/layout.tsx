...
export const metadata: Metadata = {
  ...
  title: {
    default: "Jasa Sketsa Wajah Manual - Kiky art | Kado Unik & Lukis Wajah",
    template: "%s | Kiky art",
  },

  description: "Pesan jasa sketsa wajah manual & digital art untuk kado unik. Kiky art menghadirkan lukisan wajah berkualitas dari Muhammad Rizky, Ogan Ilir, Palembang.",
  ...
  openGraph: {
    ...
    url: "https://kyy.art",
    siteName: "Kiky art",
    title: "Kiky art | High-End Portrait Gallery",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Kiky art Portfolio Gallery",
      },
    ],
  },
  twitter: {
