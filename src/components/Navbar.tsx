  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          kiky.
          <span className="not-italic font-sans font-bold text-xs uppercase tracking-widest ml-1">
            art
          </span>
        </Link>
        ...
        <div className="hidden md:flex items-center space-x-12">
          ...
          <Link
            href="/admin"
            className="w-px h-px opacity-0 flex items-center justify-center cursor-default"
            tabIndex={-1}
          >
            .
          </Link>
